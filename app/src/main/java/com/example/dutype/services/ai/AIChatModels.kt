...
/**
 * AI Chatbot & Protection Models
 * 
 * Models for worker/employer chatbots and protection services
 */
...
@Keep
data class JobSafetyRequest(
    val job: Map<String, Any>,
    val employer: Map<String, Any>? = null
)

@Keep
data class JobSafetyResponse(
...
@Keep
data class ScoreExplanationRequest(
    val score: Map<String, Any>,
    val metrics: Map<String, Any>
)

@Keep
data class ScoreExplanationResponse(
    val explanation: String,
    val breakdown: List<ScoreBreakdownItem>,
    @SerializedName("improvement_areas") val improvementAreas: List<String>
)
...
@Keep
data class PenaltyExplanationRequest(
    val penalty: Map<String, Any>
)

@Keep
data class PenaltyExplanationResponse(
    val explanation: String,
    val reason: String,
    @SerializedName("expires_at") val expiresAt: Long?,
    @SerializedName("how_to_prevent") val howToPrevent: List<String>
)

@Keep
data class ImprovementTipsResponse(
    val success: Boolean,
    val tips: String, // AI-generated tips as text
    @SerializedName("weak_areas") val weakAreas: List<String> = emptyList(),
    @SerializedName("current_score") val currentScore: Int = 0,
    @SerializedName("priority_actions") val priorityActions: List<String> = emptyList()
)
