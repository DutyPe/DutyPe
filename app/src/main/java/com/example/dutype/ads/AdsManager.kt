...
/**
 * Unified Ads Manager
 * Handles Google Mobile Ads SDK initialization and Interstitial Ad management
 * 
 * CONSOLIDATED: Merged AdsManager + InterstitialAdManager into single file
 * @since January 2026
 */
object AdsManager {
    ...
    fun initializeMobileAds(context: Context) {
        ...
        Timber.i("Google Mobile Ads SDK initialization disabled (testing)")
    }
     ...
     * Use this for loading and showing interstitial ads
     */
    fun createInterstitialManager(context: Context): InterstitialAdManager {
