...
class JobMatchingService @Inject constructor() {
     ...
     */
    private fun calculateSkillMatch(userSkills: List<com.example.dutype.profile.models.Skill>, job: JobCardModel): Double {
        ...
        val advancedSkillBonus = userSkills
            .filter { it.level == com.example.dutype.profile.models.SkillLevel.ADVANCED || 
                     it.level == com.example.dutype.profile.models.SkillLevel.EXPERT }
    ...
    private fun calculateExperienceMatch(
        userExperience: List<com.example.dutype.profile.models.WorkExperience>,
        job: JobCardModel
    ): Double {
    ...
    private fun calculateLocationMatch(
        userAddress: com.example.dutype.profile.models.Address,
        job: JobCardModel
    ): Double {
    ...
    private fun calculateSalaryMatch(
        userSalaryExpectation: com.example.dutype.profile.models.SalaryRange?,
        job: JobCardModel
    ): Double {
     ...
     */
    private fun calculateUserExperienceYears(workExperience: List<com.example.dutype.profile.models.WorkExperience>): Int {
