...
class JobRecommendationService @Inject constructor() {
    ...
    private fun generateSalaryBasedRecommendations(
        ...
        val smartSalaryRange = com.example.partimes.smart.models.SalaryRange(
     ...
     */
    private fun calculateUserExperience(workExperience: List<com.example.partimes.profile.models.WorkExperience>): Int {
