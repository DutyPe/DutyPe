...
public class JobApplicationController {
    ...
    public ResponseEntity<Map<String, Object>> submitApplication(@RequestBody JobApplication application) {
        ...
        if (application.getJobseekerId() == null || application.getJobseekerId().isEmpty()) {
            Map<String, Object> errorResponse = new HashMap<>();
            errorResponse.put("success", false);
            errorResponse.put("message", "Jobseeker ID is required");
            return ResponseEntity.badRequest().body(errorResponse);
        }
        
        if (application.getJobseekerEmail() == null || application.getJobseekerEmail().isEmpty()) {
            Map<String, Object> errorResponse = new HashMap<>();
            errorResponse.put("success", false);
            errorResponse.put("message", "Jobseeker email is required");
            return ResponseEntity.badRequest().body(errorResponse);
        }
