 ...
 * Uses Hilt-injected InAppNotificationManager singleton
 */
@Composable
fun InAppNotificationProvider(
    ...
    val notificationManagerViewModel = androidx.hilt.navigation.compose.hiltViewModel<com.example.dutype.viewmodels.InAppNotificationManagerViewModel>()
    val notificationManager = notificationManagerViewModel.notificationManager
...
/**
 * Hook for accessing notification manager via Hilt
 */
@Composable
