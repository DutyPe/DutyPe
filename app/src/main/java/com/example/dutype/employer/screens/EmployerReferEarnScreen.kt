...
fun EmployerReferEarnScreen(
    ...
    // Simulate new referral - defined first so it can be referenced by startRealTimeSimulation
    ...
    // Real-time simulation function - defined after simulateNewReferral and simulateStatusUpdate
    val startRealTimeSimulation: () -> Unit = {
        coroutineScope.launch {
            while (true) {
...
// NOTE: CoroutineScope.simulateNewReferral() removed - dead code
// The local lambda simulateNewReferral in EmployerReferEarnScreen handles this functionality
